...
<head>
  ...
  <style>
    .error-section {
      ...
      position: relative;
      overflow: hidden;
      background: linear-gradient(180deg, var(--dt-warm-white) 0%, var(--dt-ivory) 100%);
    }
    ...
    .error-bg-glow-1 {
      ...
      width: 500px;
      height: 500px;
      background: radial-gradient(circle, rgba(183, 110, 121, 0.15) 0%, rgba(255, 255, 255, 0) 70%);
      border-radius: 50%;
      filter: blur(60px);
      z-index: 1;
      pointer-events: none;
    ...
    .error-bg-glow-2 {
      ...
      width: 600px;
      height: 600px;
      background: radial-gradient(circle, rgba(27, 42, 74, 0.08) 0%, rgba(255, 255, 255, 0) 70%);
      border-radius: 50%;
      filter: blur(60px);
      z-index: 1;
      pointer-events: none;
    ...
    /* Animated 404 Number using Theme Charcoal & Rose Gold Champagne */
    .error-number {
      ...
      line-height: 0.9;
      margin-bottom: 20px;
      background: linear-gradient(135deg, var(--dt-charcoal) 0%, var(--dt-charcoal-light) 50%, var(--dt-champagne) 100%);
      -webkit-background-clip: text;
      -webkit-text-fill-color: transparent;
      display: inline-block;
      letter-spacing: -2px;
      filter: drop-shadow(0 15px 25px rgba(27, 42, 74, 0.1));
    ...
    <div class="container-xl">
      <div class="error-container">
        ...
        <div class="error-actions">
          ...
          <a href="book-appointment" class="btn btn-outline-gold btn-lg rounded-pill px-4">
